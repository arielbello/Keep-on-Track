...
public class ColoredGUISkinMobile : MonoBehaviour {
	...
	public void UpdateGuiColors(Color color, Color secondaryColor) {
		...
		color = Color.white;
		actualSkin.settings.cursorColor = new Color(0.1f, 0.1f, 0.1f);
		...
		actualSkin.horizontalSlider.normal.background = UpdateGuiSkin(customSkin.window.normal.background, color);

		// Horizontal slider thumb
		actualSkin.horizontalSliderThumb = new GUIStyle("horizontalsliderthumb");
		actualSkin.horizontalSlider.normal.background = UpdateGuiSkin(customSkin.window.normal.background, secondaryColor);
